...
export class NarrativeCreator {
  ...
  async fromFile(path: string): Promise<void> {
    ...
    const introFile = await this.voiceCreator.createForText(narrative.intro);
    console.log(`intro file: ${introFile.path}`);

    console.info(`creating firstParagraph: ${narrative.firstParagraph.slice(0, 20)}...`);
    const firstParagraphFile = await this.voiceCreator.createForText(narrative.firstParagraph);
    console.log(`firstParagraph file: ${firstParagraphFile.path}`);

    console.info(`creating firstTitle: ${narrative.firstTitle.slice(0, 20)}...`);
    const firstTitleFile = await this.voiceCreator.createForText(narrative.firstTitle);
    ...
    const secondParagraphFile = await this.voiceCreator.createForText(narrative.secondParagraph);
    ...
    const secondTitleFile = await this.voiceCreator.createForText(narrative.secondTitle);
    ...
    const thirdParagraphFile = await this.voiceCreator.createForText(narrative.thirdParagraph);
    console.log(`thirdParagraph file: ${thirdParagraphFile.path}`);

    console.info(`creating thirdTitle: ${narrative.thirdTitle.slice(0, 20)}...`);
    const thirdTitleFile = await this.voiceCreator.createForText(narrative.thirdTitle);
    console.log(`thirdTitle file: ${thirdTitleFile.path}`);

    console.info(`creating outro: ${narrative.outro.slice(0, 20)}...`);
    const outroFile = await this.voiceCreator.createForText(narrative.outro);
